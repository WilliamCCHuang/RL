...
def run_NstepTD_prediction(grid_world: GridWorld):
    ...
    grid_world.visualize(
        ...
        show=False,
        filename="NstepTD_prediction.png",
    )
    grid_world.reset()
    grid_world.reset_step_count()
    print()
...
if __name__ == "__main__":
    # len of traj: 51257
    # num episodes: 300
    # each episode starts at the 0-th state
    ...
    # num_episodes = 0
    # while grid_world.check():
    #     next_state, reward, done = grid_world.step()
