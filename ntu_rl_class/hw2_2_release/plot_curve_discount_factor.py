...
def run_Q_Learning(grid_world: GridWorld, iter_num: int, discount_factor: int):
    ...
    wandb.init(
        project="RL HW2 Reward Loss Curve of Q Learning in Different Discount Factor",
        name=f'γ={discount_factor}',
        config={
            "γ": discount_factor,
        }
    )
...
if __name__ == '__main__':
    for gamma in [0.01, 0.1, 0.5, 0.9, 0.99]:
        ...
        run_Q_Learning(grid_world, 50000, gamma)
