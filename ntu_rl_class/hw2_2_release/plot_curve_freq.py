...
def run_Q_Learning(grid_world: GridWorld, iter_num: int, freq: int):
    ...
    wandb.init(
        project="RL HW2 Reward Loss Curve of Q Learning in Different Update Frequence",
        name=f'freq={freq}',
        config={
            "freq": freq,
        }
...
if __name__ == '__main__':
    for freq in [10, 50, 100, 150, 200]:
        grid_world = init_grid_world()
        run_Q_Learning(grid_world, 50000, freq)
