...
def run_MC_policy_iteration(grid_world: GridWorld, iter_num: int, epsilon: float):
    ...
    grid_world.visualize(
        ...
        title="MC Policy Iteration",
        show=False,
        filename=f"MC_policy_iteration_epsilon={epsilon}.png",
    )

    wandb.init(
        project="RL HW2 Reward Loss Curve of MC",
...
def run_SARSA(grid_world: GridWorld, iter_num: int, epsilon: float):
    ...
    grid_world.visualize(
        ...
        title="SARSA",
        show=False,
        filename=f"SARSA_iteration_epsilon={epsilon}.png",
    )

    wandb.init(
        project="RL HW2 Reward Loss Curve of SARSA",
        name=f'epsilon={epsilon}',
        config={
            "epsilon": epsilon,
        }
...
def run_Q_Learning(grid_world: GridWorld, iter_num: int, epsilon: float):
    ...
    grid_world.visualize(
        ...
        title="Q_Learning",
        show=False,
        filename=f"Q_Learning_iteration_epsilon={epsilon}.png",
    )
    
    wandb.init(
        project="RL HW2 Reward Loss Curve of Q Learning",
        name=f'epsilon={epsilon}',
        config={
            "epsilon": epsilon,
        }
